          ...
          <b-col cols="4" v-if="etapa === 0">
            <div>
              <b-row class="justify-content-center">
                ...
                <b-form-select v-model="addPedidoAcai.sabor" :options="this.op_sabor"></b-form-select>
                <h5 class="p-3">Escolha o Tamanho do seu Açai</h5>
                <b-form-select v-model="addPedidoAcai.tamanho" :options="this.op_tam"></b-form-select>
              </b-row><br>
              <b-button @click="required" class="mt-4" pill block variant="outline-primary">Escolher Adicionais<b-icon icon="arrow-bar-right"></b-icon></b-button>
            </div>
          </b-col>
          <b-col cols="4" v-else-if="etapa==1">
            <div>
              <b-row class="justify-content-center">
                ...
                <div>
                  <b-button @click="adicional = true" pill variant="outline-success">Manda Ver<b-icon icon="arrow-bar-bottom"></b-icon></b-button>
                  <b-button @click="adicional = false; addPedidoAcai.adicional = ''" pill variant="outline-danger">Quero Não<b-icon icon="arrow-bar-right"></b-icon></b-button>
                ...
                <div>
                  <b-card no-body v-on="calcula()">
                    ...
                    <b-card-text> 
                      ...
                      <p>Valor Total: R$ {{  addPedidoAcai.valor_total }},00</p>
                    </b-card-text>
                  </b-card>
                </div>
              </b-row><br>
